...
else ifeq ($(BR2_TOOLCHAIN_EXTERNAL_FOXP),y)
TOOLCHAIN_EXTERNAL_SITE = http://downloads.sourceforge.net/project/samygo/Toolchains/
TOOLCHAIN_EXTERNAL_SOURCE = VDLinux-arm-v7a15v3r1.tar.gz
TOOLCHAIN_EXTERNAL_BIN := $(TOOLCHAIN_EXTERNAL_INSTALL_DIR)/VDLinux-arm-v7a15v3r1/bin

else ifeq ($(BR2_TOOLCHAIN_EXTERNAL_FOXB),y)
TOOLCHAIN_EXTERNAL_SITE = http://downloads.sourceforge.net/project/samygo/Toolchains/
TOOLCHAIN_EXTERNAL_SOURCE = VDLinux-arm-v7a8v3r1.tar.gz
TOOLCHAIN_EXTERNAL_BIN := $(TOOLCHAIN_EXTERNAL_INSTALL_DIR)/VDLinux-arm-v7a8v3r1/bin

else ifeq ($(BR2_TOOLCHAIN_EXTERNAL_ECHO),y)

TOOLCHAIN_EXTERNAL_INSTALL_DIR=$(HOST_DIR)/opt/ext-toolchain/VDLinux-armv7a8v2r2
TOOLCHAIN_EXTERNAL_SITE = http://downloads.sourceforge.net/project/samygo/Toolchains/
TOOLCHAIN_EXTERNAL_SOURCE = VDLinux-ARMv7-4.4-202-toolchain-v2r2-20110630.tgz
TOOLCHAIN_EXTERNAL_BIN := $(TOOLCHAIN_EXTERNAL_INSTALL_DIR)/bin

else ifeq ($(BR2_TOOLCHAIN_EXTERNAL_GENOA),y)
TOOLCHAIN_EXTERNAL_SITE = http://downloads.sourceforge.net/project/samygo/Toolchains/
