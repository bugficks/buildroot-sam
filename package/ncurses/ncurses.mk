...
define NCURSES_INSTALL_TARGET_CMDS
	...
	mkdir -p $(STAGING_DIR)/usr/include/ncurses
	cp -dpf $(STAGING_DIR)/usr/include/curses.h $(STAGING_DIR)/usr/include/ncurses/curses.h
	cp -dpf $(STAGING_DIR)/usr/include/term.h $(STAGING_DIR)/usr/include/ncurses/term.h
	(cd $(STAGING_DIR)/usr/include/ncurses; ln -fs curses.h ncurses.h)
